...
export default {
  ...
  resumo: 'Monumentos culturais protegidos. Antes de convidar alguém a visitar, é preciso saber o que existe, o que está em pé e o que está protegido — e as três respostas não são a mesma.',
  ...
  secoes: [
    ...
    },
    {
      ...
      blocos: [
        ...
        'A comparação entre essa fotografia e o mesmo ponto hoje é, ela própria, o melhor inventário informal que o distrito tem: mostra o que permaneceu, o que mudou e o que sumiu. É o que a seção <a href="index.html#antes-depois">Antes e depois</a> existe para fazer, e ela precisa de mais pares de imagens.',
        { lacuna: 'O que falta: <strong>a lista dos bens edificados do distrito</strong>, com endereço, proprietário, estado de conservação e situação de proteção. Existe algum bem tombado em Morro Vermelho — pelo IPHAN, pelo IEPHA-MG ou pelo município de Caeté? Se sim, quais, por qual processo? Se não, quais deveriam ser propostos?' },
        { sub: 'Bens a verificar, um por um' },
        { lista: [
          'Igreja Matriz — data de construção, reformas, acervo de imaginária e alfaia, situação de proteção e horário de visitação.',
