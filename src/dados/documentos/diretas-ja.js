...
export default {
  ...
  tom: 'var(--terra-600)',
  estado: 'A pesquisar · testemunhas vivas',
  ...
  secoes: [
    ...
    },
    {
      ...
      blocos: [
        ...
        { lacuna: 'As perguntas: <strong>em que data exata ocorreu o ato, quem o convocou, quantas pessoas participaram e o que foi dito?</strong> Houve mais de um? A afirmação de precedência é sobre o Brasil, sobre Minas Gerais ou sobre a região de Caeté? E que reação veio depois — do poder local, da imprensa, do aparato de repressão?' },
        'A pergunta sobre a precedência merece ser feita com todas as letras, porque ela é verificável. Datas de comício foram noticiadas, fotografadas e, no caso de atos políticos naquele período, monitoradas por órgãos de informação cujos arquivos hoje são públicos.',
    ...
    },
    {
      ...
      blocos: [
        ...
        'Quem organizou aquele ato tinha, digamos, trinta anos em 1984. Hoje tem mais de setenta. A janela para gravar essas vozes com qualidade, com calma e com autorização assinada não é indefinida — e, ao contrário de um documento de cartório, uma memória perdida não pode ser reencontrada por ninguém.',
