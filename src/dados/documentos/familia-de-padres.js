...
export default {
  ...
  secoes: [
    ...
    },
    {
      ...
      blocos: [
        ...
        { lacuna: 'As perguntas: <strong>qual o nome completo do comendador, em que ano recebeu a comenda, de qual ordem pontifícia e por qual serviço?</strong> Onde nasceu, onde estudou, que paróquias serviu, onde está sepultado? E quantos padres, ao todo, essa família deu — com nomes, datas de ordenação e parentesco entre eles?' },
  ...
  relacionadas: [
    ...
    { nome: 'Nossa Gente, Nossa História', txt: 'As famílias do distrito, contadas por elas mesmas.' },
  ],
};
