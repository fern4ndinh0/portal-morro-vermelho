  ...
  secoes: [
    ...
    },
    {
      ...
      blocos: [
        ...
        { nota: 'Este é o caso exemplar do que a página <a href="bens-historicos.html">Bens Históricos</a> descreve. O tombamento federal impede a descaracterização, como deve. Mas quando uma obra malfeita é executada primeiro e a irregularidade é constatada depois, o resultado prático é um impasse: não se pode consertar do jeito errado, ninguém se organiza para consertar do jeito certo, e o perigo permanece. A proteção do patrimônio não é o problema aqui — a obra sem projeto aprovado é.', titulo: 'O que este impasse ensina sobre tombamento' },
