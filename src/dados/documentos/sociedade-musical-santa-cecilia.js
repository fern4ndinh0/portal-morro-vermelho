...
export default {
  ...
  relacionadas: [
    { nome: 'Festas e Tradições', href: 'festas-e-tradicoes.html', txt: 'O calendário que a banda sustenta.', olho: '17' },
    { nome: 'Nossa Gente, Nossa História', href: 'nossa-gente.html', txt: 'As famílias do distrito, a banda é um mapa delas.', olho: '27' },
  ],
};
